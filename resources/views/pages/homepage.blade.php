            ...
            <div class="container">
                <div class="flex flex-wrap items-center">
                    <div class="w-full lg:w-1/2">
                        <p class="h2 leading-none">{{$translations['slider.text_1']['text']}}</p>
                        <h1 class="h1 !text-[160px] leading-none text-secondary">
                            <p>{{$translations['slider.sale']['text']}}</p>
                        </h1>
                        <a href="https://frontstore.theshop.sk"
                           class="button button--primary button--inline">{{$translations['slider.go_to_shop']['text']}}</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="text-center">
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/3 lg:px-8">
                            ...
                            <h3 class="h3">{{$translations['advantages.item_title']['text']}} 1</h3>
                        ...
                        <div class="w-full lg:w-1/3 lg:px-8">
                            ...
                            <h3 class="h3">{{$translations['advantages.item_title']['text']}} 2</h3>
                        ...
                        <div class="w-full lg:w-1/3 lg:px-8">
                            ...
                            <h3 class="h3">{{$translations['advantages.item_title']['text']}} 3</h3>
