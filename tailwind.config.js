module.exports = {
    ...
    theme: {
        ...
        extend: {
            fontSize: {
                'heading-2xl': ['4.8rem', {lineHeight: 1}],
                'heading-xl': ['3.8rem', {lineHeight: 1}],
                'heading-l': ['3.4rem', {lineHeight: 1}],
                'heading-m': ['3rem', {lineHeight: 1}],
                'heading-s': ['2.6rem', {lineHeight: 1}],
                'heading-xs': ['2.2rem', {lineHeight: 1}],
                'heading-2xs': ['2rem', {lineHeight: 1}],
