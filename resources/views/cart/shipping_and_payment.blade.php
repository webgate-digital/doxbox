...
@section('js')
    <script>
        function selectDefaultShippingCountry(country) {
            document.getElementById('default_shipping_country_input').value = country;
            document.getElementById('order-loading-wrapper').style.display = 'flex';
            document.getElementById('selectDefaultShippingCountryForm').submit();
        }

        function submitShippingToc() {
            let checked = document.getElementById('toc').checked;
            if (checked) {
                document.getElementById('order-loading-wrapper').style.display = 'flex';
                document.getElementById('continue-to-checkout').submit();
            } else {
